...
function main() 
{
    ...
    export OPTIMIZATION_FLAGS_FOR_GNU_COMPILERS="-O3 -fPIC -fopenmp -msse4.2 -mavx"
    ...
    export OPTIMIZATION_FLAGS_FOR_INTEL_COMPILERS="-DI64 -O3 -fPIC -unroll -ip -axCORE-AVX2 -qopenmp -qopt-report-phase=all -qopt-report-file:stdout -qopt-report=0"
    
    export OPTIMIZATION_FLAGS_FOR_INTEL_FORTRAN_COMPILERS="-O3 -fPIC -unroll -ip -axCORE-AVX2 -qopenmp -qopt-report-phase=all -qopt-report-file:stdout -qopt-report=0"
